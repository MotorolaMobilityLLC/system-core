...
typedef enum {
    ...
    HAL_COLOR_MODE_NIGHT_A,
    HAL_COLOR_MODE_NIGHT_B,
    HAL_COLOR_MODE_NIGHT_C,
    HAL_COLOR_MODE_NIGHT_D,
    HAL_COLOR_MODE_NIGHT_E,
    HAL_COLOR_MODE_NIGHT_F,
    HAL_COLOR_MODE_NIGHT_G,
    HAL_COLOR_MODE_NIGHT_H,
    HAL_COLOR_MODE_NIGHT_I,
    HAL_COLOR_MODE_NIGHT_J,
    HAL_COLOR_MODE_NIGHT_K,
    HAL_COLOR_MODE_NIGHT_L,
    HAL_COLOR_MODE_NIGHT_M,
    HAL_COLOR_MODE_NIGHT_N,
    HAL_COLOR_MODE_NIGHT_O,
    HAL_COLOR_MODE_NIGHT_P,
    HAL_COLOR_MODE_NIGHT_Q,
    HAL_COLOR_MODE_NIGHT_R,
    HAL_COLOR_MODE_NIGHT_Z_OFF,
    HAL_COLOR_MODE_WARM_SRGB,
    HAL_COLOR_MODE_WARM_ADOBE_RGB,
    HAL_COLOR_MODE_COOL_SRGB,
    HAL_COLOR_MODE_COOL_ADOBE_RGB,
    HAL_COLOR_MODE_MAX_VALUE = HAL_COLOR_MODE_COOL_ADOBE_RGB,
...
>>>>>>> 9054209... IKSWO-9680 graphics-base.h: support cool and warm tone color modes
