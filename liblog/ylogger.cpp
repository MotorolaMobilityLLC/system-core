...
static std::shared_timed_mutex logd_socket_lock;
...
int LogdWriteEx(log_id_t logId, struct timespec* ts, struct iovec* vec, size_t nr) {
  ssize_t ret;
  ...
  for (payloadSize = 0, i = headerLength; i < nr + headerLength; i++) {
    ...
    if (0 == prop_read){
        //char version_prop[PROPERTY_VALUE_MAX];
        //property_get("ro.build.type", version_prop, "user");
        //if (strstr(version_prop, "userdebug")) {
        //      do_log_retry=1;
        //}else{
        //      do_log_retry=0;
        //}
