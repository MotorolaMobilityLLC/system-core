...
void PropertyLoadBootDefaults() {
    ...
    if (ro_carrier != "unknown" && !ro_carrier.empty() && ro_carrier != "default") {
	    ...
	    for (const auto& moto_overlay_prop : MOTO_OVERLAY_PROPS) {
            ...
            // moto fingerprint 
	    // motorola/aaaa/aaaa_retail:11/RTA31.XXX/Y:user/release-keys
       ...
       std::string baseOS_user = "motorola/aaaa_retail/aaaa:11/RTA31.68-25/25:user/release-keys";
       //std::string baseOS_userdebug = "motorola/aaaa_retail/aaaa:11/RTA31.68-25/25:userdebug/release-keys";
