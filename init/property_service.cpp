...
void PropertyLoadBootDefaults() {
    ...
    if (ro_carrier != "unknown" && !ro_carrier.empty() && ro_carrier != "default") {
	    ...
	    for (const auto& moto_overlay_prop : MOTO_OVERLAY_PROPS) {
            ...
            // moto fingerprint 
	    // motorola/aaa/aaa_retail:11/RTA31.XXX/Y:user/release-keys
       ...
       std::string baseOS_user = "motorola/aaa_retail/aaa:11/RTA31.68-29/29:user/release-keys";
       //std::string baseOS_userdebug = "motorola/aaa_retail/aaa:11/RTA31.68-25/25:userdebug/release-keys";
