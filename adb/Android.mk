...
ifeq ($(JOURNEY_FEATURE_FACTORY_REQUEST), yes)
LOCAL_CFLAGS += -DJOURNEY_FEATURE_FACTORY_REQUEST
endif
...
# depend with JOURNEY_FEATURE_DEBUG_MODE
ifeq ($(JOURNEY_FEATURE_DEBUGG_MODE_ROOT), yes)
LOCAL_CFLAGS += -DJOURNEY_FEATURE_DEBUGG_MODE_ROOT
endif

ifeq ($(TINNO_FACTORY_SUPPORT), true)
LOCAL_CFLAGS += -DTINNO_FACTORY_SUPPORT
endif

ifeq ($(MOTO_FACTORY_SUPPORT), true)
LOCAL_CFLAGS += -DMOTO_FACTORY_SUPPORT
endif
