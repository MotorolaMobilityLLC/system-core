...
struct ss_func_header {
    __le32 ss_magic;
    __le32 ss_count;
} __attribute__((packed));

struct ss_func_descs {
    struct usb_interface_descriptor intf;
    struct usb_endpoint_descriptor_no_audio sink;
...
struct desc_v1 {
    ...
    struct ss_func_header ss_header;
    struct ss_func_descs ss_descs;
} __attribute__((packed));
...
struct ss_func_descs ss_descriptors = {
    .intf = {
    ...
    .comp_sink = {
        .bLength = sizeof(ss_descriptors.comp_sink),
    ...
    .comp_source = {
        .bLength = sizeof(ss_descriptors.comp_source),
        .bDescriptorType = USB_DT_SS_ENDPOINT_COMP,
        .bMaxBurst = 0,
        .bmAttributes = 0,
        .wBytesPerInterval = 0,
...
static void init_functionfs(struct usb_handle *h)
{
    ...
    if (h->control < 0) { // might have already done this before
        ...
        if (ret < 0) {
            ...
            v1_descriptor.ss_header = ss_header;
            v1_descriptor.ss_descs = ss_descriptors;
