...
func mtkLogdEnhanceSimple(ctx android.LoadHookContext) {
	type props struct {
		Cflags           []string
		Shared_libs      []string
		Header_libs      []string
...
func init() {
	...
	android.RegisterModuleType("mtk_logdEnhance_simple", mtkLogdEnhanceSimpleFactory)
}
...
func mtkLogdEnhanceSimpleFactory() android.Module {
	module := cc.DefaultsFactory()
	android.AddLoadHook(module, mtkLogdEnhanceSimple)
	return module
}
